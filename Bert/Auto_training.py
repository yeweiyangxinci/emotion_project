...
class AutoProcessor(DataProcessor):
    def _create_model(self, data_dir):
        examples = []
...
class AutoClassifier(object):
    ...
    def auto_training(self, data_dir, label_list):

        processors = {
            "auto": AutoProcessor
        }

        basic_dir = "sentiment_emotion/Bert/"
        ...
        init_checkpoint = basic_dir + "chinese_L-12_H-768_A-12/ bert_model.ckpt"
        ...
        tokenization.validate_case_matches_checkpoint(do_lower_case[0], init_checkpoint)
